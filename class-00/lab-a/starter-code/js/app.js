...
function displayPics() {
  ...
  //because let is block-scoped, by placing a "let" into fucntion displayPics, it could no longer be accessed by the rest of the code (globally), so by trying to call it outside of its scope, the "let" breaks the code because it doesn't know where to access that declaration
  //console.log(rando);
